        ...
        <div class="flex flex-col gap-6">
          ...
          <div class="flex justify-end">
            <button 
              @click="addPost"
              :disabled="isPosting"
              class="w-full md:w-auto px-10 py-4 bg-zinc-100 hover:bg-zinc-900 text-zinc-900 hover:text-white dark:bg-zinc-300 hover:dark:bg-white dark:text-black rounded-lg font-black text-sm uppercase tracking-wider active:scale-[0.98] transition-all duration-300 border border-zinc-200 dark:border-none disabled:opacity-50 disabled:scale-100"
            >
