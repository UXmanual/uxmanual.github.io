          ...
          <div v-if="groupedNews.length > 0" class="space-y-10">
            ...
            <div v-if="filteredNews.length > visibleCount" class="flex justify-center pt-10">
              <button 
                ...
                class="px-12 py-4 bg-zinc-600 hover:bg-zinc-900 text-white dark:bg-zinc-300 hover:dark:bg-white dark:text-black rounded-lg font-semibold text-base leading-normal tracking-tight active:scale-[0.98] transition-all duration-300"
              >
                헤드라인 더보기
              </button>
            </div>
...
const CURRENT_CACHE_VERSION = 'v12.0'
