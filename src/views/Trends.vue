<template>
  ...
  >
    ...
    <!-- Footer Section -->
    <footer class="mt-20 border-t border-zinc-100 dark:border-white/5 py-16 px-6 md:px-10">
      <div class="max-w-[1800px] mx-auto text-center space-y-4">
        <p class="text-sm font-bold text-zinc-400 dark:text-zinc-500 tracking-wide uppercase">
          Powered by RSS feeds from various sources.
        </p>
        <p class="text-xs leading-relaxed text-zinc-400/80 dark:text-zinc-600 max-w-2xl mx-auto">
