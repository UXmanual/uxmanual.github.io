<template>
  <nav 
    :class="[
      ...
      'top-0 left-0 right-0 z-[70] bg-zinc-50/90 dark:bg-[#131313]/90 backdrop-blur-xl transition-all duration-500',
  ...
  >
    <div class="site-nav-container px-6 md:px-10 flex justify-between items-center w-full">
      ...
      <div class="flex items-center gap-4 md:gap-8">
        ...
        <button 
          @click="toggleTheme" 
          class="p-2.5 rounded-full bg-zinc-100 dark:bg-zinc-800/80 text-zinc-600 dark:text-zinc-300 transition-all duration-300 hover:scale-105 active:scale-95 group/theme flex items-center justify-center"
